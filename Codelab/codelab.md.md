...
4. **Guarda los cambios antes de salir:**  
   ...
   **Resultado:** Al encender el equipo, deberás ingresar la nueva contraseña para iniciar el sistema operativo.  
   ![contraseña de usuario][img/bios- contraseña.png]
...
![supervisor password][img/bios - set supervisor password.png]
...
![control de arranque USB][img/bios- controlar el arranque.png]
